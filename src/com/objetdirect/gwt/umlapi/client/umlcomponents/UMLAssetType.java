...
public class UMLAssetType{

	public static UMLAssetType parseAttribute(final String attributeToParse) {
		...
		return new UMLAssetType(visibility,type,name);
	}
	...
	public UMLAssetType(final UMLVisibility visibility , final String type, final String name){ //type==kata name==stereotype
		super();
