...
public class UseCaseRelationLinkArtifact extends RelationLinkArtifact {
	 ...
	 */
	public UseCaseRelationLinkArtifact(final UseCaseArtifact left, final UseCaseArtifact right, final LinkKind relationKind) {
