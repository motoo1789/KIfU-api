...
public class MisActorPartGfxArtifact extends NodePartArtifact {
	...
	public MisActorPartGfxArtifact() {
		super();
	...
	public void buildGfxObject() {
		if (this.textVirtualGroup == null) {
		    ...
		    this.gfxImage = GfxManager.getPlatform().buildImage("misActor.png");
...
//		GfxManager.getPlatform().setFillColor(this.gfxImage, ThemeManager.getTheme().getClassBackgroundColor());
	...
	public GfxObject getOutline() {
		...
		final GfxObject image = GfxManager.getPlatform().buildImage("misActor.png");
