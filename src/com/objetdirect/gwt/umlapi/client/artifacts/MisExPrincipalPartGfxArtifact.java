...
public class MisExPrincipalPartGfxArtifact extends NodePartArtifact {
	...
	public MisExPrincipalPartGfxArtifact() {
		super();
	...
	public void buildGfxObject() {
		if (this.textVirtualGroup == null) {
		    ...
		    this.gfxImage = GfxManager.getPlatform().buildImage("misExtendActor2.png");
...
//		GfxManager.getPlatform().setFillColor(this.gfxImage, ThemeManager.getTheme().getClassBackgroundColor());
	...
	public GfxObject getOutline() {
		...
		final GfxObject image = GfxManager.getPlatform().buildImage("misExtendActor2.png");
